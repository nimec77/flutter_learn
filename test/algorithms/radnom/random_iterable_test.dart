import 'package:flutter_learn/learn/algorithms/radnom/random_iterable_all.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {

  test('Test 10 elements', () {
    final randomIterable = RandomIterableAll(10);
  ...
  test("test a 1,000,000,000 element for a match via the 'elementAt' method and the 'last' property", () {
    ...
    final randomIterable = RandomIterableAll(1000000000);
