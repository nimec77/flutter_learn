import 'package:flutter_learn/learn/6/tribonacci_sequence.dart';
import 'package:flutter_test/flutter_test.dart';

final tribonacciSequence = TribonacciSequence();

void tester(List<num> sig, int n, List<num> exp) =>
    test('tribonacci($sig, $n)', () => expect(tribonacciSequence.tribonacci(sig, n), equals(exp)));
